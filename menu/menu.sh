...
export sem=$( curl -s https://raw.githubusercontent.com/harimu63/v5/main/versions)
...
echo -e "${BICyan} │  ${BICyan}[${BIWhite}04${BICyan}] TROJAN  ${BICyan}[${BIYellow}Menu${BICyan}]${NC}"  "${BICyan}  [${BIWhite}11${BICyan}] CEK BANDWITH    ${BICyan}[${BIYellow}Menu${BICyan}]${NC}" "${BICyan} │${NC}"
